...
Version `0.11.0` is intended for personal research, planning, and non-binding decision support. High-risk mode adds gates and auditability; it does not prove factual verification, professional participation, or regulatory compliance. Do not use its output directly for medical, legal, financial, compliance, or safety-critical execution.
