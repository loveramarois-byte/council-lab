...
- **传统文化不是科学结论**：该模式在浏览器本地生成固定版本的历法和排盘快照，并可选择《穷通宝典》《三命通会》《滴天髓》《渊海子平》《千里命稿》《协纪辨方书》《果老星宗》《子平真诠》《神峰通考》等典籍研究方向；这些只是书名与主题索引，不内置全文或伪造引文。出生地不发送给模型，也不与高风险模式、自动总结或长期记忆混用。详见 [模式说明](docs/TRADITIONAL_CULTURE_MODE.md) 和 [第三方声明](NOTICE)。
