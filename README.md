...
<p align="center">
  <a href="https://github.com/loveramarois-byte/council-lab/releases/download/v0.18.7/Council-v0.18.7-macOS.zip"><strong>下载 macOS 版</strong></a>
  &nbsp;&nbsp;·&nbsp;&nbsp;
  <a href="https://github.com/loveramarois-byte/council-lab/releases/download/v0.18.7/Council-v0.18.7-Windows.zip"><strong>下载 Windows 版</strong></a>
</p>
...
下载 [`Council-v0.18.7-macOS.zip`](https://github.com/loveramarois-byte/council-lab/releases/download/v0.18.7/Council-v0.18.7-macOS.zip)，解压后双击 `Council.app`。当前开源构建尚未经过 Apple 公证；如果首次启动被拦截，请按住 Control 点击 App，选择 **打开** 并确认。

### Windows 10 / 11

下载 [`Council-v0.18.7-Windows.zip`](https://github.com/loveramarois-byte/council-lab/releases/download/v0.18.7/Council-v0.18.7-Windows.zip)，选择 **全部解压**，再双击 `Start Council.cmd`。不需要管理员权限。当前构建没有商业代码签名；如 SmartScreen 提示，请先确认文件来自本仓库 Release，再选择 **更多信息 → 仍要运行**。
...
Council 当前版本为 `0.18.7`，以 [Apache License 2.0](LICENSE) 开源。Council Lab 与 CC Switch 项目没有官方隶属、授权或背书关系。