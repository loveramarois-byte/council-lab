...
DOMAIN_RULES: dict[str, tuple[str, ...]] = {
    "medical": (
        ...
        "pill", "pills", "metformin", "insulin", "antibiotic", "surgery", "二甲双胍", "胰岛素",
        "抗生素", "止痛药", "安眠药", "降压药",
    ),
    "legal": (
        "法律", "诉讼", "合同", "律师", "法域", "仲裁", "起诉", "判决", "违约", "赔偿", "劳动争议",
        "房东", "租客", "驱逐", "legal", "lawsuit", "jurisdiction", "arbitration", "contract dispute",
        "landlord", "tenant", "evict", "eviction", "开除", "辞退", "裁员", "工伤", "押金", "租赁",
        "离婚", "遗嘱",
    ),
    "investment": (
        ...
        "call options", "put option", "put options", "nvda", "etf", "债券", "仓位", "炒股", "退休储蓄",
        "期货", "外汇",
    ),
    "compliance": (
