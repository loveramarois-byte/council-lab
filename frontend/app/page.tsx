...
export default function HomePage() {
  ...
  const [traditionalProfile, setTraditionalProfile] = useState<TraditionalCultureProfile>({ calendar_type: "solar", birth_date: "", birth_time: "", time_precision: "exact", gender: "male", birth_place: "", timezone: "Asia/Shanghai", true_solar_time_applied: false, focus_topics: [] });
  ...
  const submit = async (forceOverride = false) => {
    ...
    try {
      ...
      const traditionalSnapshot = traditionalMode ? await buildTraditionalCultureSnapshot(traditionalProfile) : undefined;
